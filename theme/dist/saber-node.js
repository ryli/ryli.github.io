...
exports.onCreatePages = function () {
  ...
  var posts = _toConsumableArray(this.pages.values()).filter(function (page) {
    return page.type === 'post' && !page.draft;
  }).sort(function (a, b) {
  ...
  try {
    for (var _iterator = posts.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
